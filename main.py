...
list_of_tuple = lambda list: print(sorted(list, key=lambda x: x[1]))

list_of_tuple([('English', 88), ('Science', 90), ('Maths', 97),
 ('Social sciences', 82)])
...
# Write a lambda function to determine whether a number is even or odd (the
#  function should return True or False), and then use the function and a list 
# comprehension to create a new list of booleans, where even numbers are True and odd numbers are False.
